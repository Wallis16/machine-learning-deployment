...
async def run_training(collection_name: str,
                    mlflow_uri: str, collection_ = Depends(get_database)):
    """<>"""
    try:
        ...
        return optuna_run.skelarn_model(data_for_training,
                                collection_name, mlflow_uri)
